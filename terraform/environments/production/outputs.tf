...
output "wif_provider_name" {
  description = "WIF provider resource name (use as GitHub secret WIF_PROVIDER_PRODUCTION)"
...
output "deploy_sa_email" {
  description = "Deployer service account email (use as GitHub secret WIF_SERVICE_ACCOUNT_PRODUCTION)"
